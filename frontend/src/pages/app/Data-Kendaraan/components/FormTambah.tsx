...
const FormTambah = () => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      await http.post("/api/data-kendaraan", fd, {
  ...
  if (mode !== "tambah") return null;

  return (
    <>
      <h2 className="font-semibold lg:text-lg">Tambah Data Kendaraan</h2>
      <form
      ...
      >
        ...
        <div className="flex items-center gap-2 place-self-end md:col-span-2 lg:col-span-4">
          ...
          <button
            type="submit"
            className="cursor-pointer rounded bg-green-500 px-3 py-1 text-sm font-medium text-white disabled:cursor-not-allowed disabled:bg-green-700"
            disabled={loading}
          >
