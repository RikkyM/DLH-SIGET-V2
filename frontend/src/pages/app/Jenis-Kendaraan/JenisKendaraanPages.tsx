...
import { useJenisKendaraanData } from "./hooks/useJenisKendaraanData";

const JenisKendaraanPages = () => {
  useDocumentTitle("Jenis Kendaraan");
  ...
  const {
    ...
    setPerPage,
    resetToFirstPage,
  } = useJenisKendaraanData(debouncedSearch);
    ...
    <section className="flex flex-1 flex-col gap-3 overflow-auto p-3">
      <div className="flex h-full flex-col gap-2 overflow-auto rounded-lg bg-white p-3 shadow">
        <div className="space-y-2">
          <h4 className="text-xl font-semibold">Jenis Kendaraan</h4>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="*:sticky *:top-0 *:bg-white *:p-2">
                    ...
                    <th className="text-left">Nama Jenis Kendaraan</th>
...
export default JenisKendaraanPages;
